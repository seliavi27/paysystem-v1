...
final class CreateUserCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('full-name', null, InputOption::VALUE_REQUIRED, 'Полное имя')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $fullName = $input->getOption('full-name') ?? $io->ask('Full name', validator: fn($v) => $this->requireNonEmpty($v, 'Full name'));
